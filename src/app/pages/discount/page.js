...
const products = [
  { name: "Saifco Excel (4x5kg)", mrp: 1200, consumerMrp: 1150 },
  { name: "Saifco Excel (20x1kg)", mrp: 1180, consumerMrp: 1130 },
  { name: "Saifco Wattan Se (4x5kg)", mrp: 1100, consumerMrp: 1050 },
  { name: "Saifco Wattan Se (20x1kg)", mrp: 1080, consumerMrp: 1030 },
  { name: "Saifco Super (4x5kg)", mrp: 1000, consumerMrp: 950 },
  { name: "Saifco Gold (4x5kg)", mrp: 980, consumerMrp: 930 },
  { name: "Saifco Amber (4x5kg)", mrp: 960, consumerMrp: 910 },
];
...
export default function PriceTable() {
  ...
  const finalMrp = (consumer) => {
    return (consumer * 1.05).toFixed(2);
  };
      ...
      <table className="min-w-full text-sm border border-gray-300">
        <thead className="bg-blue-50 text-xs text-gray-600 uppercase">
          <tr>
            ...
            <th className="px-3 py-2 text-left">Consumer MRP</th>
            <th className="px-3 py-2 text-left">GST 5%</th>
        ...
        <tbody>
          {products.map((p, i) => (
            <tr key={i} className="border-t border-gray-200">
              ...
              <td className="px-3 py-2">{p.consumerMrp}</td>
              <td className="px-3 py-2">5%</td>
              <td className="px-3 py-2 font-semibold text-green-600">
                ₹{finalMrp(p.consumerMrp)}
              </td>
            </tr>
          ))}
        </tbody>
